...
#
# This file defines the Genicam imported targets and sets the following cache variables:
# - Genicam_TARGETS: list of imported targets with namespace.
# - Genicam_INCLUDES: the include directory for Genicam headers.
# - Genicam_LIBRARIES: list of Genicam library names.
# - Genicam_FOUND: flag to indicate Genicam was found.

get_filename_component(PACKAGE_PREFIX_DIR "${CMAKE_CURRENT_LIST_DIR}/" ABSOLUTE)

if (UNIX)
  # Try to get architecture from the compiler
  EXECUTE_PROCESS(
...
# Set cache variables for downstream usage
...
# Set Genicam_INCLUDES to the proper include directory
set(Genicam_INCLUDES "${PACKAGE_PREFIX_DIR}/library/CPP/include" CACHE STRING "Genicam include directory")
set(Genicam_FOUND ON CACHE BOOL "")

# Do not clear PACKAGE_PREFIX_DIR at the end.
